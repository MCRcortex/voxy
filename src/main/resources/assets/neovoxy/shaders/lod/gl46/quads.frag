...
#ifdef PATCHED_SHADER
struct NeoVoxyFragmentParameters {
...
void neovoxy_emitFragment(NeoVoxyFragmentParameters parameters);
#else
...
//This is deprecated, TODO: remove the non mip code path
    ...
    neovoxy_emitFragment(NeoVoxyFragmentParameters(colour, tile, texPos, face, modelId, getLightmap(), tint, model.customId));
