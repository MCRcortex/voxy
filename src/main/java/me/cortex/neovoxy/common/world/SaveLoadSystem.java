...
public class SaveLoadSystem {
    public static final boolean VERIFY_HASH_ON_LOAD  = NeoVoxyCommon.isVerificationFlagOn("verifySectionHash");
    public static final boolean VERIFY_MEMORY_ACCESS = NeoVoxyCommon.isVerificationFlagOn("verifyMemoryAccess");
