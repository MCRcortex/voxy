...
import me.cortex.neovoxy.client.core.gl.shader.AutoBindingShader;
...
import static me.cortex.neovoxy.client.core.rendering.util.PrintfDebugUtil.PRINTF_processor;
...
public class HierarchicalOcclusionTraverser {
    public static final boolean HIERARCHICAL_SHADER_DEBUG = System.getProperty("neovoxy.hierarchicalShaderDebug", "false").equals("true");
    ...
    private final AutoBindingShader traversal = Shader.makeAuto(PRINTF_processor)
            ...
            .add(ShaderType.COMPUTE, "neovoxy:lod/hierarchical/traversal_dev.comp")
            .compile();
    ...
    private void uploadUniform(Viewport<?> viewport) {
        ...
        final float screenspaceAreaDecreasingSize = NeoVoxyConfig.CONFIG.subDivisionSize*NeoVoxyConfig.CONFIG.subDivisionSize;
