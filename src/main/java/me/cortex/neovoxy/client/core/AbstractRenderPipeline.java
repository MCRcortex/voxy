...
import me.cortex.neovoxy.client.core.rendering.post.FullscreenBlit;
import me.cortex.neovoxy.client.core.rendering.section.backend.AbstractSectionRenderer;
import me.cortex.neovoxy.client.core.rendering.util.DepthFramebuffer;
...
public abstract class AbstractRenderPipeline extends TrackedObject {
    ...
    private final FullscreenBlit depthMaskBlit = new FullscreenBlit("neovoxy:post/fullscreen2.vert", "neovoxy:post/noop.frag");
    private final FullscreenBlit depthSetBlit = new FullscreenBlit("neovoxy:post/fullscreen2.vert", "neovoxy:post/depth0.frag");
    private final FullscreenBlit depthCopy = new FullscreenBlit("neovoxy:post/fullscreen2.vert", "neovoxy:post/depth_copy.frag");
    ...
    public void runPipeline(Viewport<?> viewport, int sourceFrameBuffer, int srcWidth, int srcHeight) {
        ...
        var occlusionDebug = NeoVoxyClient.getOcclusionDebugState();
        if (occlusionDebug==0) {
    ...
    protected void initDepthStencil(int sourceFrameBuffer, int targetFb, int srcWidth, int srcHeight, int width, int height) {
        ...
        //Make neovoxy terrain render only where there isnt mc terrain
        glStencilOp(GL_KEEP, GL_KEEP, GL_KEEP);
