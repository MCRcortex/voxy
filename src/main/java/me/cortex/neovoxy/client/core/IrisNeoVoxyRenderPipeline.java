...
public class IrisNeoVoxyRenderPipeline extends AbstractRenderPipeline {
    private final IrisNeoVoxyRenderPipelineData data;
    private final FullscreenBlit depthBlit = new FullscreenBlit("neovoxy:post/blit_texture_depth_cutout.frag");
    public final DepthFramebuffer fbTranslucent = new DepthFramebuffer(this.fb.getFormat());

    private final GlBuffer shaderUniforms;

    public IrisNeoVoxyRenderPipeline(IrisNeoVoxyRenderPipelineData data, AsyncNodeManager nodeManager, NodeCleaner nodeCleaner, HierarchicalOcclusionTraverser traversal, BooleanSupplier frexSupplier) {
