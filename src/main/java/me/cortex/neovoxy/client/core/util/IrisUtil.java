...
public class IrisUtil {
    ...
    public record CapturedViewportParameters(ChunkRenderMatrices matrices, FogParameters parameters, double x, double y, double z) {
        public Viewport<?> apply(NeoVoxyRenderSystem vrs) {
    ...
    public static final boolean SHADER_SUPPORT = true;//System.getProperty("neovoxy.enableExperimentalIrisPipeline", "false").equalsIgnoreCase("true");
