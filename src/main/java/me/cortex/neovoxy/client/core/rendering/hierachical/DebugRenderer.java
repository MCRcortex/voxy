...
public class DebugRenderer {
    private final Shader debugShader = Shader.make()
            .add(ShaderType.VERTEX, "neovoxy:lod/hierarchical/debug/node_outline.vert")
            .add(ShaderType.FRAGMENT, "neovoxy:lod/hierarchical/debug/frag.frag")
            .compile();
    private final Shader setupShader = Shader.make()
            .add(ShaderType.COMPUTE, "neovoxy:lod/hierarchical/debug/setup.comp")
            .compile();
