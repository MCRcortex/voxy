...
import me.cortex.neovoxy.client.core.rendering.GeometryCache;
import me.cortex.neovoxy.client.core.rendering.SectionUpdateRouter;
...
import me.cortex.neovoxy.client.core.rendering.section.geometry.BasicAsyncGeometryManager;
...
public class AsyncNodeManager {
    ...
    private final Shader scatterWrite = Shader.make()
            ...
            .add(ShaderType.COMPUTE, "neovoxy:util/scatter.comp")
            .compile();
    ...
    private final Shader multiMemcpy = Shader.make()
            ...
            .add(ShaderType.COMPUTE, "neovoxy:util/memcpy.comp")
            .compile();
