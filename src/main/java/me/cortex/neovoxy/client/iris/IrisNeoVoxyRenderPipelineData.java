...
import me.cortex.neovoxy.client.core.IrisNeoVoxyRenderPipeline;
import me.cortex.neovoxy.client.mixin.iris.CustomUniformsAccessor;
import me.cortex.neovoxy.client.mixin.iris.IrisRenderingPipelineAccessor;
...
public class IrisNeoVoxyRenderPipelineData {
    public IrisNeoVoxyRenderPipeline thePipeline;
    ...
    private IrisNeoVoxyRenderPipelineData(IrisShaderPatch patch, int[] opaqueDrawTargets, int[] translucentDrawTargets, StructLayout uniformSet, Runnable blendingSetup, ImageSet imageSet, SSBOSet ssboSet) {
    ...
    public static IrisNeoVoxyRenderPipelineData buildPipeline(IrisRenderingPipeline ipipe, IrisShaderPatch patch, CustomUniforms cu, ShaderStorageBufferHolder ssboHolder) {
        ...
        return new IrisNeoVoxyRenderPipelineData(patch, opaqueDrawTargets, translucentDrawTargets, uniforms, patch.createBlendSetup(), imageSet, ssboSet);
    }
